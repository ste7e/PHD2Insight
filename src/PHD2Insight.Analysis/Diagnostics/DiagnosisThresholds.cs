internal static class DiagnosisThresholds {
    ...
    public const double MediumRaOscillationEventsPerMinute = 1.0;
    public const double HighRaOscillationEventsPerMinute = 3.0;

    public const int HighRaDirectionReversals = 150;

    public const double LargeAverageRaPulseMilliseconds = 200;

    public const double MediumRaOscillationAmplitudeArcSeconds = 0.50;
